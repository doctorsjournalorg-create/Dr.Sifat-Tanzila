            ...
            <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
              <p>
                {isBn
                  ...
                  : 'Dr. Sifat Tanzila completed her MBBS from Chittagong Medical College (CMC) with academic distinction. She subsequently earned her FCPS in Surgery and cleared the rigorous Royal College exams to attain the MRCS (England/UK).'}
              </p>
              <p>
                {isBn
